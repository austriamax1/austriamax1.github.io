...
El análisis **[post-ajuste](https://cran.r-project.org/web/packages/betareg/vignettes/T4P3_Postajuste.html)** nos muestra que los residuales forman patrones de lineas, por lo que posiblemente requieran un tratamiento adicional.
